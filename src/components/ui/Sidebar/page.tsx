        ...
        >
          <div className="pr-4 pt-10 pb-2">
            <div className="relative">
              <FaMagnifyingGlass className="w-5 h-5 absolute left-3 inset-y-0 my-auto text-zinc-500" />
              <Input
                required
                    ...
                    {marketingUISections.map((item, idx) => (
                      <li key={idx}>
                        <NavLink
                          ...
                          className="hover:bg-zinc-900 hover:text-zinc-100 hover:translate-x-4 hover:transition-all duration-300"
                          active="bg-zinc-900 text-zinc-100 font-medium translate-x-4"
                        >
                          {item.section_name}
                        </NavLink>
                      </li>
